...
def _weekly_confirmation_contract(conf):
    ...
    # شرط السلامة الأعلى: لا يسمح أبداً بحالة CONFIRMED عندما يكون شرط
    # الإغلاق في الاتجاه المطلوب غير متحقق. قوة الشمعة تبقى معلومة مستقلة.
    if side_ok is False:
        normalized = "WATCH"
        display_status = "🟡 يحتاج تحقق شرط الإغلاق"
    elif side_ok is True and raw == "🟢 مؤكد مبدئياً":
    ...
    if horizon == "weekly":
        ...
        if bull is None or bear is None:
            ...
            bull = {
                ...
                "confirmation": _weekly_confirmation_contract(_breakout_confirmation(d1_df, nearest_resistance(levels, price), "BUY", "weekly", frames_data["D1"].get("atr", 0))),
            ...
            bear = {
                ...
                "confirmation": _weekly_confirmation_contract(_breakout_confirmation(d1_df, nearest_support(levels, price), "SELL", "weekly", frames_data["D1"].get("atr", 0))),
