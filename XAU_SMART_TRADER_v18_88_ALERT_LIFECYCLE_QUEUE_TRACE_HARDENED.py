...
# v18.88 Telegram lifecycle telemetry thresholds (diagnostic-only).
...
def webhook():
    ...
    v18.88: explicitly measures the gap between HTTP receipt and coroutine start.
