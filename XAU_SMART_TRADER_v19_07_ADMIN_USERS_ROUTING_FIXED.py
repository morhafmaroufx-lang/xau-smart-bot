...
def main_v19_07():
    if "--v19-07-admin-users-self-test" in sys.argv:
        print(json.dumps(run_v19_07_admin_users_tests(), ensure_ascii=False, indent=2))
        return
    # Preserve v19.06 production entry point exactly; only the final callback_router
    # binding above is different for this release.
    return main_v19_06()
