...
VERSION = "v18.65-INSTITUTIONAL-IMF-CROSS-VALIDATION-TRACE-HARDENED-WGC-ARABIC-PRE-SMC-INDEPENDENT-NEWS-EMBEDDED"
...
def _cb_real():
    ...
    try:
        ...
        IMF_LAST_DIAGNOSTIC.update({'pipeline_stage':'COVERAGE_CHECK','countries_common':len(common)})
        if len(common)<20:
