...
async def send_market_session_alerts():
    ...
    for label, zone_name, hour in specs:
        ...
        results = await _dispatch_broadcast(recipients, with_market_header(text), kind="session")
        # Do not permanently mark an event delivered when every recipient delivery failed.
