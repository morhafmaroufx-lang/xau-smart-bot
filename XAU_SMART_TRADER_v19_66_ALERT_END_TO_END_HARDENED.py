...
if __name__ == "__main__":
    if "--v19-53-runtime-self-test" in sys.argv:
    ...
    elif "--gy-accuracy-self-test" in sys.argv:
        print(json.dumps(run_v19_56_gy_accuracy_self_tests(), ensure_ascii=False, indent=2))
