...
# Performance Auditor: مستقل اختياري؛ أي خطأ فيه لا يوقف محرك التداول.
try:
    from xau_performance_auditor import PerformanceAuditor
    ...
    logger_bootstrap = logging.getLogger("xau_performance_auditor_bridge")
    logger_bootstrap.warning("Performance Auditor unavailable: %s", _auditor_exc)

# ============================================================
# الإعدادات
# ============================================================

VERSION = "v18.34-PRE-SMC"
...
def get_news_events(force=False):
    """جلب تقويم اقتصادي عالي التأثير. فشل المصدر = UNKNOWN ولا يعني عدم وجود خبر."""
    global NEWS_CACHE
    now_ts = time.time()
