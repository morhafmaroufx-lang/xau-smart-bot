...
VERSION = "v18.39-PRE-SMC-INDEPENDENT-NEWS"
...
# ============================================================
# INDEPENDENT NEWS RISK ENGINE v18.38
...
# ============================================================
from news_engine_v18_39 import get_events as _local_news_events, get_risk as _local_news_risk

def get_news_events(force=False):
    """LOCAL-ONLY read path. force is retained for API compatibility; no HTTP call occurs."""
    events = _local_news_events()
    return [{
        **e,
...
async def start_bot():
    ...
    try:
        from news_engine_v18_38 import start_background_refresh
