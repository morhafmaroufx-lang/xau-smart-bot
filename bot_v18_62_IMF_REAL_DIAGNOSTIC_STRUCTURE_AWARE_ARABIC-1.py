...
VERSION = "v18.62-INSTITUTIONAL-IMF-REAL-DIAGNOSTIC-STRUCTURE-AWARE-WGC-CROSS-VALIDATED-ARABIC-PRE-SMC-INDEPENDENT-NEWS-EMBEDDED"
...
def _imf_irfcl_monthly(indicator):
    ...
    IMF_LAST_DIAGNOSTIC.update({'status':'FAILED','failure_stage':'ACQUISITION_OR_SCHEMA','error':str(last),'error_type':type(last).__name__ if last else None})
